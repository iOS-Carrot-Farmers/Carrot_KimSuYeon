...
class CustomTabBarController: UITabBarController {
    ...
    func setTabBar() {
        guard let homeNC = self.storyboard?.instantiateViewController(withIdentifier: "HomeNC"),
        ...
        homeNC.tabBarItem = UITabBarItem(title: "홈", image: UIImage(named: "homeIcon"), selectedImage: UIImage(named: "homeIconFill"))
        ...
        setViewControllers([homeNC,townVC,myAroundVC,chatVC,myCarrotVC], animated: true)
    }
